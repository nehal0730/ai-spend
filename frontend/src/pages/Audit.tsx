...
import { ArrowLeft, ArrowDown, BarChart3, Zap } from 'lucide-react'
import SpendInputForm from '../components/spend-form/SpendInputForm'
          ...
          >
            <div>
              ...
              <p className="text-lg text-slate-300 md:text-xl leading-relaxed max-w-2xl">
                Enter your current stack, save your data locally, and get instant insights on your AI spending patterns.
              </p>
            </div>
            ...
            <div className="grid gap-3 md:gap-4 md:grid-cols-3 max-w-2xl">
              ...
              <div className="rounded-lg border border-blue-500/20 bg-blue-500/10 p-3 md:p-4">
                ...
                <p className="text-sm text-slate-300">Nothing sent to our servers</p>
              </div>
            </div>
