...
export default function ResultsCTA({ report, onRequestEmail, onRequestConsultation }: Props) {
  ...
  if (shouldEscalate) {
    return (
      <section className="relative overflow-hidden rounded-[1.9rem] border border-cyan-400/20 bg-[linear-gradient(180deg,rgba(6,182,212,0.10),rgba(255,255,255,0.95))] p-5 shadow-2xl shadow-cyan-950/10 backdrop-blur-xl dark:bg-[linear-gradient(180deg,rgba(6,182,212,0.18),rgba(15,23,42,0.92))] dark:shadow-cyan-950/20">
        ...
        <h2 className="relative mt-4 text-2xl font-black tracking-tight text-primary dark:text-white">Credex can help capture this faster</h2>
        <p className="relative mt-3 text-sm leading-6 text-muted dark:text-slate-300">
        ...
        <div className="relative mt-5 grid gap-3 sm:grid-cols-3">
          <div className="rounded-[1.25rem] border border-cyan-400/15 bg-white px-4 py-3 dark:bg-white/5">
            <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-cyan-700 dark:text-cyan-200">Monthly</p>
            <p className="mt-1 text-xl font-black text-primary dark:text-white">${formatMoney(monthlySavings)}</p>
          </div>
          <div className="rounded-[1.25rem] border border-cyan-400/15 bg-white px-4 py-3 dark:bg-white/5">
            <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-cyan-700 dark:text-cyan-200">Annual</p>
            <p className="mt-1 text-xl font-black text-primary dark:text-white">${formatMoney(annualSavings)}</p>
          </div>
          <div className="rounded-[1.25rem] border border-cyan-400/15 bg-white px-4 py-3 dark:bg-white/5">
            <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-cyan-700 dark:text-cyan-200">Savings rate</p>
            <p className="mt-1 text-xl font-black text-primary dark:text-white">{savingsRate.toFixed(1)}%</p>
          </div>
        </div>
  ...
  if (isLowSavings) {
    return (
      <section className="relative overflow-hidden rounded-[1.9rem] border border-emerald-400/20 bg-[linear-gradient(180deg,rgba(16,185,129,0.10),rgba(255,255,255,0.95))] p-5 shadow-2xl shadow-slate-950/10 backdrop-blur-xl dark:bg-[linear-gradient(180deg,rgba(16,185,129,0.14),rgba(15,23,42,0.92))] dark:shadow-slate-950/20">
        ...
        <h2 className="relative mt-4 text-2xl font-black tracking-tight text-primary dark:text-white">Your stack is already fairly efficient</h2>
        <p className="relative mt-3 text-sm leading-6 text-muted dark:text-slate-300">
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.9rem] border border-amber-400/20 bg-[linear-gradient(180deg,rgba(251,191,36,0.10),rgba(255,255,255,0.95))] p-5 shadow-2xl shadow-slate-950/10 backdrop-blur-xl dark:bg-[linear-gradient(180deg,rgba(251,191,36,0.14),rgba(15,23,42,0.92))] dark:shadow-slate-950/20">
      ...
      <h2 className="relative mt-4 text-2xl font-black tracking-tight text-primary dark:text-white">Meaningful savings, but not a full overhaul</h2>
      <p className="relative mt-3 text-sm leading-6 text-muted dark:text-slate-300">
